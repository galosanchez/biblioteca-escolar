...
/**
 * Esta clase permite crear un nuevo estudiante
 *
 * @author Galo Sánchez
 */
public class DialogNewStudent extends javax.swing.JDialog {

    private int xMouse, yMouse;
    private final JFrame jFrameParent;

    public DialogNewStudent(JFrame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabelTitle.setText("Nuevo estudiante");
        ...
        jPanelForm.add(jTextFieldCI, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 156, 200, 20));
        ...
        jPanelForm.add(jLabelErrorCI, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 181, 200, 14));
        ...
        jLabelButtonCreate.setText("Crear estudiante");
    ...
    private void jTextFieldCIFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextFieldCIFocusGained
        chanceColorFocusSeparator("Gained", jPanelFocusCI);
    ...
    private void jTextFieldCIFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextFieldCIFocusLost
        chanceColorFocusSeparator("Lost", jPanelFocusCI);
    ...
    /**
     * Eventos de boton "Crear estudiante". Mejorar apariencial al entrar con el
     * mouse
     */
    ...
    /**
     * Evento click del boton "Crear estudiante".
     */
    private void jLabelButtonCreateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelButtonCreateMouseClicked
        ...
        /* Validar que no exista un estudiante con la cédula ingresada */
        try {
            if (StudentController.existStudentCedula(jTextFieldCI.getText()) > 0) {
                jLabelErrorCI.setText("Existe un registro con esta cédula.");
                return;
            }
        } catch (Exception e) {
            if (e.getLocalizedMessage().equals("3011")) {
        ...
        /* Crea una objeto estudiante y se asigna los atributos */
        Student student = new Student();
        student.setCedula(jTextFieldCI.getText());
        ...
        try {
            ...
            if (StudentController.createStudent(student) > 0) {
    ...
    private boolean validarCamposFormato() {
        ...
        /* Validación de la cedula: debe tener obligatorimente 10 dígitos */
        if (jTextFieldCI.getText().length() < 1) {
            verif = false;
            jLabelErrorCI.setText("Olvidaste ingrese la cédula.");
        } else {
            // valida que la cadena solo lleve numeros
            if (!validateTextFieldNumber(jTextFieldCI.getText())) {
                verif = false;
                jLabelErrorCI.setText("Solo números");
            } else {
                // valida que la cadena tengo 10 caracteres
                if (jTextFieldCI.getText().length() != 10) {
                    verif = false;
                    jLabelErrorCI.setText("La cédula debe tener 10 dígitos.");
                }
            }
        }
